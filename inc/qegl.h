...
//
// OpenGL extension function addresses populated by qe
//
...
GLAPI PFNGLDETACHSHADERPROC glAttachShader;
...
QE_API int qeShaderMapVars(int prg,qeShaderVarRec *vars);
QE_API int qeVertexBufferBuild(float *verts,int *faces,int numf,chr *sp,...);
